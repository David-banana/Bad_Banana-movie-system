        ...
        <nav role="navigation" class="probootstrap-nav hidden-xs">
          <ul class="probootstrap-main-nav">
            ...
            <c:if test="${empty user }">
						<li class="mr-lg-4 mr-3"><a href="/BadBanana/loginandregister/login.jsp?loginPath=services" class="scroll">登录</a></li>
						</c:if>
						<c:if test="${!empty user }">
						...
						<li class="mr-lg-4 mr-3"><a href="/BadBanana/clearSessionServlet?quitPath=services" class="scroll">退出</a></li>
						</c:if>
